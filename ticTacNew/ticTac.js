(function () {
  ...
  const TurnController = (() => {
    ...
    const playerTurn = (currentToken, currentScore) => {
      return {
        ...
        logCurrentUserInfo: function () {
          return `${getActivePlayer().name} clicks ${
    ...
    const playRound = (value) => {
      ...
      return "Round end"; // removes undefined in console
    };
  ...
  const GameController = (() => {
    ...
    const cacheDom = () => {
      ...
      elements.playerOneName = document.querySelector(".playerOneName p");
      elements.playerTwoName = document.querySelector(".playerTwoName p");
    ...
    const bindEvents = () => {
      let placeholderTextOne = "Player one name...";
      let placeholderTextTwo = "Player two name...";

      placeHolderName(placeholderTextOne);
      elements.question.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          placeHolderName(placeholderTextTwo);
          ...
          placeholderText = "Player two name...";
        }
      });
    ...
    const placeHolderName = (placeholder) => {
      elements.question.setAttribute("placeholder", placeholder);
    };
